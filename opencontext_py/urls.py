...
urlpatterns = [
    ...
    # Sets views
    re_path(r'^sets/(?P<spatial_context>\S+)?.json', SearchViews.sets_view, name='sets_json'),
    re_path(r'^sets/(?P<spatial_context>\S+)?.atom', SearchViews.sets_view, name='sets_atom'),
    re_path(r'^sets/(?P<spatial_context>\S+)?', SearchViews.sets_view, name='sets_html'),
    # Lightbox views
    re_path(r'^lightbox/(?P<spatial_context>\S+)?.json', SearchViews.lightbox_view, name='lightbox_json'),
    re_path(r'^lightbox/(?P<spatial_context>\S+)?.atom', SearchViews.lightbox_view, name='lightbox_atom'),
    re_path(r'^lightbox/(?P<spatial_context>\S+)?', SearchViews.lightbox_view, name='lightbox_html'),
    # Search views
    re_path(r'^subjects-search.json?', SearchViews.subjects_json_view, name='subjects_search_json_d'),
    re_path(r'^subjects-search/(?P<spatial_context>\S+)?.json', SearchViews.subjects_json_view, name='subjects_search_json'),
    re_path(r'^subjects-search/(?P<spatial_context>\S+)?', SearchViews.subjects_html_view, name='subjects_search_html'),
    re_path(r'^media-search.json?', SearchViews.media_json_view, name='media_search_json_d'),
    re_path(r'^media-search/(?P<spatial_context>\S+)?.json', SearchViews.media_json_view, name='media_search_json'),
    re_path(r'^media-search/(?P<spatial_context>\S+)?', SearchViews.media_html_view, name='media_search_html'),
    re_path(r'^projects-search.json?', SearchViews.projects_json_view, name='projects_search_json_d'),
    re_path(r'^projects-search/(?P<spatial_context>\S+)?.json', SearchViews.projects_json_view, name='projects_search_json'),
    re_path(r'^projects-search/(?P<spatial_context>\S+)?', SearchViews.projects_html_view, name='projects_search_html'),
    ...
    re_path(r'^database/space.php', SubjectViews.old_redirect_view, name='old_redirect_html'),
    re_path(r'^subjects/(?P<uuid>\S+)?\.jsonld$', SubjectViews.jsonld_view, name='subjects_jsonld'),
    re_path(r'^subjects/(?P<uuid>\S+)?\.geojson$', SubjectViews.geojson_view, name='subjects_geojson'),
    re_path(r'^subjects/(?P<uuid>\S+)?\.json$', SubjectViews.json_view, name='subjects_json'),
    re_path(r'^subjects/(?P<uuid>\S+)?\.nt$', SubjectViews.ntrpls_view, name='subjects_ntrpls'),
    re_path(r'^subjects/(?P<uuid>\S+)?\.rdf$', SubjectViews.rdf_view, name='subjects_rdf'),
    re_path(r'^subjects/(?P<uuid>\S+)?\.ttl$', SubjectViews.turtle_view, name='subjects_turtle'),
    re_path(r'^subjects/(?P<uuid>\S+)', SubjectViews.html_view, name='subjects_html'),
    re_path(r'^subjects', SubjectViews.index, name='subjects_index_html_s'),
    # Media views (media resources / metadata + binary files)
    re_path(r'^media/(?P<uuid>\S+)?\.jsonld$', MediaViews.jsonld_view, name='media_jsonld'),
    re_path(r'^media/(?P<uuid>\S+)?\.geojson$', MediaViews.geojson_view, name='media_geojson'),
    re_path(r'^media/(?P<uuid>\S+)?\.json$', MediaViews.json_view, name='media_json'),
    re_path(r'^media/(?P<uuid>\S+)?\.nt$', MediaViews.ntrpls_view, name='media_ntrpls'),
    re_path(r'^media/(?P<uuid>\S+)?\.rdf$', MediaViews.rdf_view, name='media_rdf'),
    re_path(r'^media/(?P<uuid>\S+)?\.ttl$', MediaViews.turtle_view, name='media_turtle'),
    re_path(r'^media/(?P<uuid>\S+)/full', MediaViews.html_full, name='media_full'),
    re_path(r'^media/(?P<uuid>\S+)', MediaViews.html_view, name='media_html'),
    re_path(r'^media', MediaViews.index, name='media_index_html_s'),
    # Document views for HTML document items
    re_path(r'^documents/(?P<uuid>\S+)?\.jsonld$', DocumentViews.jsonld_view, name='documents_jsonld'),
    re_path(r'^documents/(?P<uuid>\S+)?\.geojson$', DocumentViews.geojson_view, name='documents_geojson'),
    re_path(r'^documents/(?P<uuid>\S+)?\.json$', DocumentViews.json_view, name='documents_json'),
    re_path(r'^documents/(?P<uuid>\S+)?\.nt$', DocumentViews.ntrpls_view, name='documents_ntrpls'),
    re_path(r'^documents/(?P<uuid>\S+)?\.rdf$', DocumentViews.rdf_view, name='documents_rdf'),
    re_path(r'^documents/(?P<uuid>\S+)?\.ttl$', DocumentViews.turtle_view, name='documents_turtle'),
    re_path(r'^documents/(?P<uuid>\S+)', DocumentViews.html_view, name='documents_html'),
    re_path(r'^documents', DocumentViews.index, name='documents_index'),
    ...
    re_path(r'^projects/(?P<uuid>\S+)?\.jsonld$', ProjectViews.jsonld_view, name='projects_jsonld'),
    re_path(r'^projects/(?P<uuid>\S+)?\.geojson$', ProjectViews.geojson_view, name='projects_geojson'),
    re_path(r'^projects/(?P<uuid>\S+)?\.json$', ProjectViews.json_view, name='projects_json'),
    re_path(r'^projects/(?P<uuid>\S+)?\.nt$', ProjectViews.ntrpls_view, name='projects_ntrpls'),
    re_path(r'^projects/(?P<uuid>\S+)?\.rdf$', ProjectViews.rdf_view, name='projects_rdf'),
    re_path(r'^projects/(?P<uuid>\S+)?\.ttl$', ProjectViews.turtle_view, name='projects_turtle'),
    re_path(r'^projects/(?P<uuid>\S+)', ProjectViews.html_view, name='projects_html'),
    re_path(r'^project-layers/(?P<uuid>\S+)', ProjectViews.layers_view, name='projects_layers'),
    ...
    re_path(r'^predicates/(?P<uuid>\S+)?\.jsonld$', PredicateViews.jsonld_view, name='predicates_jsonld'),
    re_path(r'^predicates/(?P<uuid>\S+)?\.json$', PredicateViews.json_view, name='predicates_json'),
    re_path(r'^predicates/(?P<uuid>\S+)?\.nt$', PredicateViews.ntrpls_view, name='predicates_ntrpls'),
    re_path(r'^predicates/(?P<uuid>\S+)?\.rdf$', PredicateViews.rdf_view, name='predicates_rdf'),
    re_path(r'^predicates/(?P<uuid>\S+)?\.ttl$', PredicateViews.turtle_view, name='predicates_turtle'),
    re_path(r'^predicates/(?P<uuid>\S+)', PredicateViews.html_view, name='predicates_html'),
    ...
    re_path(r'^types/(?P<uuid>\S+)?\.jsonld$', OCtypeViews.jsonld_view, name='types_jsonld'),
    re_path(r'^types/(?P<uuid>\S+)\.json$', OCtypeViews.json_view, name='types_json'),
    re_path(r'^types/(?P<uuid>\S+)?\.nt$', OCtypeViews.ntrpls_view, name='types_ntrpls'),
    re_path(r'^types/(?P<uuid>\S+)?\.rdf$', OCtypeViews.rdf_view, name='types_rdf'),
    re_path(r'^types/(?P<uuid>\S+)?\.ttl$', OCtypeViews.turtle_view, name='types_turtle'),
    re_path(r'^types/(?P<uuid>\S+)', OCtypeViews.html_view, name='types_html'),
