...
from opencontext_py.apps.indexer import index_slim_schema as slim_ind
...
slim_ind.make_index_site_page_solr_documents()
...
all_uuids = slim_ind.get_uuids_associated_with_vocab(vocab_uri='vocab.getty.edu/aat')
...
slim_ind.clear_caches()
slim_ind.make_indexed_solr_documents_in_chunks(uuids)
suggest.get_rebuild_solr_suggest()
...
def get_solr_connection():
    ...
    if solr_search_configs.USE_TEST_SOLR_CONNECTION:
        ...
        solr = SolrClient(use_alt_collection=True, use_test_solr=True).solr
    else:
