...
# events.
ROOT_EVENT_CLASS = SolrDocSlim.ALL_EVENTS_SOLR
...
DEFAULT_FACET_FIELDS = [
    ...
    SolrDocSlim.ALL_LINK_DATA_SOLR,
    SolrDocSlim.ROOT_OC_CATEGORY_SOLR,
    SolrDocSlim.ALL_LINK_DATA_SOLR,
...
SITEMAP_FACET_FIELD = SolrDocSlim.ALL_PROJECT_SOLR
...
ROOT_OC_CATEGORY_SOLR = SolrDocSlim.ROOT_OC_CATEGORY_SOLR
ITEM_CAT_FIELDS = [
    ROOT_OC_CATEGORY_SOLR,
]

REL_CAT_FACET_FIELDS = [
    f'{SolrDocSlim.RELATED_SOLR_DOC_PREFIX}{ROOT_OC_CATEGORY_SOLR}'
]
...
HIERARCHY_PARAM_TO_SOLR = [
    ...
    (
        'proj', SolrDocSlim.ALL_PROJECT_SOLR,
        {
            'root_field': SolrDocSlim.ALL_PROJECT_SOLR,
            'field_suffix': SolrDocSlim.FIELD_SUFFIX_PROJECT,
        },
    ),
    (
        'cat', SolrDocSlim.ROOT_OC_CATEGORY_SOLR,
        {
            'root_field': SolrDocSlim.ROOT_OC_CATEGORY_SOLR,
            'field_suffix': SolrDocSlim.ROOT_OC_CATEGORY_SOLR,
        },
    ),
    (
        'prop', None,
        {
            'root_field': SolrDocSlim.ALL_PREDICATE_SOLR,
            'field_suffix': SolrDocSlim.FIELD_SUFFIX_PREDICATE,
        },
    ),
    (
        'dc-subject', None,
...
RELATED_ENTITY_ID_PREFIX = SolrDocSlim.RELATED_SOLR_DOC_PREFIX.replace('_', '-')
...
ALL_ATTRIBUTE_GROUPS_SLUG = SolrDocSlim.ALL_ATTRIBUTE_GROUPS_SLUG
...
FACETS_CONTEXT_SUFFIX = (
    SolrDocSlim.SOLR_VALUE_DELIM + SolrDocSlim.FIELD_SUFFIX_CONTEXT
)
FACETS_PROP_SUFFIX = (
    SolrDocSlim.SOLR_VALUE_DELIM + SolrDocSlim.FIELD_SUFFIX_PREDICATE
)
FACETS_PROJ_SUFFIX = (
    SolrDocSlim.SOLR_VALUE_DELIM + SolrDocSlim.FIELD_SUFFIX_PROJECT
)
...
FACET_STANDARD_ROOT_FIELDS = {
    ...
    (
        SolrDocSlim.RELATED_SOLR_DOC_PREFIX
        + SolrDocSlim.ALL_PREDICATE_SOLR
    ): {
...
MIN_GEOTILE_ZOOM = SolrDocSlim.MIN_GEOTILE_ZOOM
MAX_GEOTILE_ZOOM = SolrDocSlim.MAX_GEOTILE_ZOOM
