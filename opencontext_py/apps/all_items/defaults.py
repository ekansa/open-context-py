...
DEFAULT_MANIFESTS = [
    ...
    {
        'uuid': PREDICATE_OC_ETL_MEDIA_PART_OF,
        'publisher_id': OPEN_CONTEXT_PUB_UUID,
        'project_id': OPEN_CONTEXT_PROJ_UUID,
        'item_class_id': DEFAULT_CLASS_UUID,
        'source_id': DEFAULT_SOURCE_ID,
        'item_type': 'predicates',
        'data_type': 'id',
        'slug': 'oc-gen-etl-media-part-of',
        'label': 'Media part of (ETL)',
        'item_key': 'oc-gen:etl-media-part-of',
        'uri': 'opencontext.org/vocabularies/oc-general/etl-media-part-of',
        'context_id': OC_GEN_VOCAB_UUID,
    },
    {
