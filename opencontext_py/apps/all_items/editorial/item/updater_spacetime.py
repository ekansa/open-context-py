...
def make_note_spacetime_note_string(spacetime_obj):
...
def update_spacetime_fields(request_json):
...
def add_spacetime_objs(request_json, source_id=DEFAULT_SOURCE_ID):
    ...
    for item_add in request_json:
        ...
        sp_note = make_note_spacetime_note_string(spacetime_obj)
        edit_note = (
            f'Added {sp_note}'
        )
...
def delete_spacetime_objs(request_json):
    ...
    for item_delete in request_json:
        ...
        sp_note = make_note_spacetime_note_string(to_delete_spt_obj)
        edit_note = (
            f'Deleted {sp_note}'
        )
